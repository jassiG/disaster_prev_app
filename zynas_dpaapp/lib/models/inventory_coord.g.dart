...
part of 'inventory_coord.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class InventoryCoordAdapter extends TypeAdapter<InventoryCoord> {
  @override
  final int typeId = 1;

  @override
  InventoryCoord read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, InventoryCoord obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.link)
  ...
  bool operator ==(Object other) =>
      ...
      other is InventoryCoordAdapter &&
